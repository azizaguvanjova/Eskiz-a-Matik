...
export default function App() {
  ...
  /* Challenge 
     ...
     1. Kullanıcının imleci "wrapper" div içinde herhangi bir yerde aşağı veya yukarı giderse, "mouseDown" state'i sırasıyla true veya false 
     olarak ayarlanmalıdır. Başka bir deyişle:
...
            ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯    
     ...
     2. mouseDown true ise ve kullanıcının imleci "pixel" div'lerinden birine girerse, pixels state array'inde o div'e karşılık gelen pixel 
     data nesnesinin "filled" özelliği "wantsToDraw" true ise true, "wantsToDraw" false ise false olarak ayarlanmalıdır. Başka bir deyişle,
      mouseDown === true && kullanıcının imleci pixel[n]'e karşılık gelen div'e girerse,
...
            ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
     ...
     3. Bu ve diğer tüm piksel veri nesnelerinin diğer tüm özellikleri korunmalıdır. Başka bir deyişle, hedeflenen belirli piksel veri nesnesinin 
     yalnızca "filled" özelliği değiştirilmelidir. Diğer her şey aynı kalmalıdır. 
